...
function UpdateModal (props) {
    const isOpenedUpdate = props.toggle;
    ...
    const submitForm = (data) => {
        ...
        axios.post(`http://127.0.0.1:8000/api/users/${userId}` , formData).then((res) => {
            action();
            props.updateTable();
            console.log(res);
    ...
    return  (
        <>
            <div id="myModal" className={isOpenedUpdate ? `${styled.openedModal}` : `${styled.modal}`}>
